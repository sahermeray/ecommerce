                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> االمتاجر
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group"
                                                        ...
                                                        <a href="{{route('admin.vendors.changeStatus',$vendor->id)}}"
                                                           class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">@if($vendor->active == 0) تفعيل
                                                            @else الغاء تفعيل @endif</a>
